...
//     }
// };
// class exam : public infor
// {
// public:
//     string grade;

//     exam(string name, int marks, int age, int class1, string grade)
//     {
//         infor(age,class1);
//         student(name,marks);
//         this->grade = grade;
...
//     cout << "Grade" << endl;
//     cin >> grade;
//     exam e1(name, marks, age, class1, grade);
//     e1.display1();
//     e1.display2();
//     e1.display3();
//     return 0;
...
public:
    ...
    exam(string name=" ", int marks=0, int age=0, int class1=0, string grade=" ")
    {
        this->name=name;
        this->marks=marks;
        this->age=age;
